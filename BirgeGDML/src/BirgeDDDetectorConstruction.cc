...
/*    G4String filename = "test/cube_placement.txt";
    ...
    G4double dose_box_x_pos = -189.0*cm; // 200*inch + (room_x_left_wall_thickness - room_inner_x - room_x_right_wall_thickness) / 2; 
    G4double dose_box_y_pos =  221.0*cm;// (room_y_front_wall_thickness + room_inner_y - room_y_back_wall_thickness) / 2 - 240*inch;
    G4double dose_box_z_pos =    8.2*cm;// 60*inch - room_inner_z/2;
